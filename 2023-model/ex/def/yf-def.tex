...
\kill}
% \def\tabpos{\hspace{3mm} \= \hspace{3mm} \= \hspace{3mm} \= \hspace{3mm} \=
% \hspace{3mm} \= \hspace{3mm} \= \hspace{3mm} \= \hspace{3mm} \= \hspace{3mm}
% \kill}
...
\newcommand{\boxminipg}[2]{\vspace{2mm} \begin{center}\fbox{\begin{minipage}{#1}#2\end{minipage}}\end{center} \vspace{2mm}}
\newcommand{\minipg}[2]{\vspace{2mm}  \begin{center}\begin{minipage}{#1}#2\end{minipage}\end{center} \vspace{2mm} }
\newcommand{\myitems}[1]{\begin{itemize}\setlength #1 \end{itemize}}
\newcommand{\myenums}[1]{\begin{enumerate}\setlength #1 \end{enumerate}}
%\newcommand{\myfig}[1]{\begin{figure}\centering #1\end{figure}}
\newcommand{\myfig}[2]{\begin{figure}\centering #1 \figcapup \caption{#2} \figcapdown \end{figure}}
\newcommand{\myfigstar}[2]{\begin{figure*}\centering #1 \figcapup \caption{#2} \figcapdown \end{figure*}}

\newcommand{\mybox}[1]{\begin{tcolorbox}[enhanced,breakable,colback=white,left=1mm,right=1mm,arc=0pt,outer arc=0pt] #1 \end{tcolorbox}}
